...
export const SET_RECIPE_TO_EDIT_START = "SET_RECIPE_TO_EDIT_START";
export const SET_RECIPE_TO_EDIT_SUCCESS = "SET_RECIPE_TO_EDIT_SUCCESS";
export const SET_RECIPE_TO_EDIT_FAIL= "SET_RECIPE_TO_EDIT_FAIL";
...
// action types for setting current recipe
